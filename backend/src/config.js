...
const namePrefix = "GammaPunk";
const description = "The Punk Is Chillin With His Symbiote Friend.";
...
const extraMetadata = {
  external_url: "https://gammapunks.xyz", // Replace with your website or remove this line if you do not have one.
};
